...
//	if listParam != nil {
//		b.limitClause = utils.NewWithParam(listParam).GetLimitClause()
//		return b.concrete
//	}
...
//	}
//
//	err = v1.Db().My().Get(v, xquery, xargs...)
//	if err != nil {
...
//	}
//
//	err = v1.Db().My().Select(v, xquery, xargs...)
//	if err != nil {
...
//	xquery, xargs, err := b.concrete.Generate()
//	if err != nil {
//		return 0, errors.Wrap(err, "generate hdsql")
//	}
//
//	var total int64
//	err = v1.Db().My().Get(&total, xquery, xargs...)
//	if err != nil {
...
//		}
//		newQuery = v1.Db().My().Rebind(newQuery)
